from ctypes import GetLastError, c_bool, c_int, c_size_t, c_ubyte, c_void_p, c_wchar_p, windll, POINTER, pointer, c_long, WINFUNCTYPE, Structure, cast, WinDLL, c_uint, sizeof, byreffrom 
ctypes.wintypes 
import HANDLE, HHOOK, HINSTANCE, BOOL, HMODULE, HRGN, LPRECT, LPUINT, POINT, WPARAM, LPARAM, MSG, LPMSG, HWND, UINT, HMENU, LPVOID, POINT, LPPOINT, RECT, ATOM, HDC, BYTE, DWORD, WORD

import enum

LRESULT = c_longLONG = c_long
